...
deps = {
  ...
  'third_party/gpgmm': {
    'url': '{github_git}/intel/gpgmm.git@2547a8761b4d73ff023e5f37eba31aa262fa00a4',
    'condition': 'checkout_win',
  },
  'third_party/oneDNN': {
    'url': '{github_git}/oneapi-src/oneDNN.git@caef251d1164c5c1e4843b647040ebbcd6fe6c40',
  },
  'third_party/XNNPACK': {
    'url': '{github_git}/google/XNNPACK.git@171bdcfcc12a253972580f2f5cc63239523f17f0'
  },
  'third_party/onnxruntime': {
    'url': '{github_git}/microsoft/onnxruntime.git@143725604e05062f653c0a5d5bd20a00284b5ebe',
