...
deps = {
  ...
  'third_party/DirectML': {
    'url': '{github_git}/microsoft/DirectML.git@4e48e631bb0ca60947e5e49d2c70f94df8282d01',
    'condition': 'checkout_win',
  },
  # GPGMM support for fast DML allocation and residency management.
  'third_party/gpgmm': {
    'url': '{github_git}/intel/gpgmm.git@0d76730b5774844a281bc5c2f1266dac6997c006',
    'condition': 'checkout_win',
  },
  'third_party/oneDNN': {
    'url': '{github_git}/oneapi-src/oneDNN.git@cfce4835fba9c6bf0be53ce1b2e040c884635fdb',
  },
  'third_party/XNNPACK': {
    'url': '{github_git}/google/XNNPACK.git@16b3379825a5de3d148658af572a0a45eea3bfa3'
  },
  'third_party/onnxruntime': {
    'url': '{github_git}/microsoft/onnxruntime.git@ade0d291749144e1962884a9cfa736d4e1e80ff8',
